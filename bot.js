...
bot.on("message", function(msg){
    ...
    if(msg.chat.id < 0 && msg.text!="/start@MTaskCryptosBot"){
        return;
    }
    ...
    if(msg.text){
        switch(msg.text){
                    ...
                    if(previous[msg.from.id]=="gro0" && msg.chat.id<0){
                        ...
                        setTimeout(()=>{
                            if(isUrl(st)){
                                ...
                                if(FUNC.FUNC.isFrench( msg.from.id)){
                                    bot.sendMessage(msg.from.id, "Vous devez ajouter ce bot (https://t.me/MTaskCryptosBot) à la liste des administrateurs de votre groupe !");
                                }else{
                                    bot.sendMessage(msg.from.id, "You must add this bot (https://t.me/MTaskCryptosBot) as administrator of your group !");
                                }
                            }
                        }, 1000)
            ...
            default:
                if(msg.text.substr(0, 7)=="/start " && !isNaN(msg.text.substr(7))){
                    ...
                    if(msg.forward_from_chat && msg.forward_from_chat.type=="channel"){
                        ...
                        setTimeout(()=>{
                            if(isUrl(st)){
                                ...
                                if(FUNC.FUNC.isFrench( msg.chat.id)){
                                    bot.sendMessage(msg.chat.id, "Ajouter ce bot (https://t.me/MTaskCryptosBot) à la liste des administrateurs de votre chaîne.");
                                }else{
                                    bot.sendMessage(msg.chat.id, "Add this bot(https://t.me/MTaskCryptosBot) to your channel's administrators.");
                                }
                            }
                        }, 1000)
...
1️⃣ Add this bot(https://t.me/MTaskCryptosBot) to your channel's administrators.\n\n \
...
1️⃣ Ajouter ce bot (https://t.me/MTaskCryptosBot) à la liste des administrateurs de votre chaîne.\n\n \
...
3️⃣ Et Suivez les instructions suivantes du bot (http://telegra.ph/How-to-give-admin-rights-to-a-bot-07-13)";
            ...
            previous[msg.message.chat.id] = "cha0"
            //console.log(msg)
        }     
    else if(msg.data=="groupe" || msg.data=="group"){
        if(msg.data=="group")
            var msgo = "📣 To start promoting your group you need:\n\n \
1️⃣ Add this bot(https://t.me/MTaskCryptosBot) to your group's administrators.\n\n \
2️⃣ Send /start@MTaskCryptosBot into group. \n\n \
3️⃣ Follow the further instructions of the bot‌ (http://telegra.ph/How-to-give-admin-rights-to-a-bot-07-13)";
        else
            var msgo = "📣 Pour promouvoir votre groupe vous devez:\n\n \
1️⃣ Ajouter ce bot (https://t.me/MTaskCryptosBot) à la liste des administrateurs de votre groupe .\n\n \
2️⃣ Envoyer /start@MTaskCryptosBot dans le groupe. \n\n \
3️⃣ Et Suivez les instructions suivantes du bot (http://telegra.ph/How-to-give-admin-rights-to-a-bot-07-13)";

            bot.sendMessage(msg.message.chat.id, msgo);

            previous[msg.message.chat.id] = "gro0"
            //console.log(msg)
            ...
            if(msg.data=="wbtc"){
                if(FUNC.FUNC.getUserXbt( msg.message.chat.id)<0.0005){
                    ...
                    previous[msg.message.chat.id] = "btcad"
                }
                ...
                if(FUNC.FUNC.getUserEth( msg.message.chat.id)<0.001){
                    ...
                    previous[msg.message.chat.id] = "ethad"
                }          
                ...
                if(FUNC.FUNC.getUserLtc( msg.message.chat.id)<0.005){
                    ...
                    previous[msg.message.chat.id] = "ltcad"
                }
            }
        }          
        else{
